"""Live-sensor entrypoint for GICP localization.

Use this when running the real robot/sensors. It forces wall-clock time
(`use_sim_time:=false`) so rosbag timestamps do not enter the TF tree.
"""
